...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Codes Testing things//test_6-3-2025_CGNet - 2//checkpoints//checkpoint20-BCE-50epochs//ResUnet49.pth"))
    model.eval()
    test_results_path="E://VS Codes Testing things//test_6-3-2025_CGNet - 2//test results//test_results20-BCE-50epochs"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs> 0.6251258850097656, 1.0,0.0)
