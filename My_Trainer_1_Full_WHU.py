...
# from CGNet.Loss_Function import *
...
train_path="D://Datasets//WHU - Tiles//train"
test_path="D://Datasets//WHU - Tiles//test"
val_path="D://Datasets//WHU - Tiles//val"


train_loader=DataLoader(change_detection_dataset(root_path=train_path),batch_size=16,shuffle=True,num_workers=0,pin_memory=False)
test_loader=DataLoader(change_detection_dataset(root_path=test_path),batch_size=8,shuffle=False,num_workers=0,pin_memory=False)
val_loader=DataLoader(change_detection_dataset(root_path=val_path),batch_size=8,shuffle=False,num_workers=0,pin_memory=False)
...
if __name__ == "__main__":
    ...
    num_epochs = 100
    save_path = "E://VS Codes Testing things//test_6-3-2025_CGNet - 2//checkpoints_FullWHU//checkpoint2-BCE-100epochs"
