...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Codes Testing things//test_6-3-2025_CGNet - 2//checkpoints_FullWHU//checkpoint1-BCE-100epochs//ResUnet21.pth"))
    model.eval()
    test_results_path="E://VS Codes Testing things//test_6-3-2025_CGNet - 2//checkpoints_FullWHU//test_results1-BCE-100epochs"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs> 0.6901788115501404, 1.0,0.0)
