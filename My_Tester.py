...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Projects//test_6-3-2025_CGNet//checkpoint1-BCE-100epochs//ResUnet99.pth"))
    model.eval()
    test_results_path="E://VS Projects//test_6-3-2025_CGNet//test_results1-BCE-100epochs"
