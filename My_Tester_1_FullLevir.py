...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Codes Testing things//test_6-3-2025_CGNet - 2//checkpoints_FullLevir//checkpoint1-BCE-50epochs//ResUnet14.pth"))
    model.eval()
    test_results_path="E://VS Codes Testing things//test_6-3-2025_CGNet - 2//test results_FullLevir//test_results1-BCE-50epochs"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs> 0.3723919689655304, 1.0,0.0)
