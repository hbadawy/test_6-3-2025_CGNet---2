...
model1.load_state_dict(torch.load("E://VS Codes Testing things//test_6-3-2025_CGNet - 2//checkpoints//checkpoint21-BCE-50epochs//ResUnet49.pth"))
model1.eval()
...
# Plot the ROC curve
plt.figure()
plt.plot(fpr, tpr, color='orange', lw=1, label=f'ROC curve (AUC = {roc_auc:.2f})')
